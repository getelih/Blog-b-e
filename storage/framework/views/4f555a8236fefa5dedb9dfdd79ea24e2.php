        ...
        <div class="card-body">
            ...
            <form action="<?php echo e(route('posts.store')); ?>" method="POST" enctype="multipart/form-data">
                ...
                <label class="w-full form-control">
                    ...
                    <input name="title" type="text" placeholder="Title" value="<?php echo e(old('title')); ?>" class="w-full input input-bordered <?php $__errorArgs = ['title'];
...
<?php echo $__env->make('partials.layout', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\Users\Geteli\kms23\Blog-b-e\resources\views\posts\create.blade.php ENDPATH**/ ?>